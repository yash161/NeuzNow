...
const UserProfile = () => {
  ...
  const handleInterestClick = (interest) => {
    // Add selected interest to the currentInterest field
    setFormData({
      ...formData,
      currentInterest: formData.currentInterest
        ? `${formData.currentInterest}, ${interest}`
        : interest,
    });
    setShowInterestOptions(false); // Close the interest options after selection
  };
      ...
      <div style={styles.container}>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.inputGroup}>
            ...
            />
            {showInterestOptions && (
              <div style={styles.interestOptions}>
...
const styles = {
  outerContainer: {
    ...
    backgroundColor: "#f4f4f4",  // Light gray background for the outer container
  },
  container: {
    maxWidth: "600px",
    width: "100%",
