  ...
  const styles = StyleSheet.create({
    ...
    tableHeader: {
      ...
      borderRadius: 10,
      marginBottom: 10,
      elevation: 3, // Shadow effect for header
    },
    row: {
      flexDirection: 'row',
    ...
    actionsCell: {
      flex: 2, // Ensure proper column width
      flexDirection: 'row',
      justifyContent: 'space-evenly',
      alignItems: 'center', // Align buttons vertically
    },
    actionButton: {
      width: 100, // Ensure enough width for button text
      paddingVertical: 6,
      borderRadius: 5,
      justifyContent: 'center', // Center text in button
      textTransform: 'none', // Prevent text truncation
    },
  });
